  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-90 flex items-center justify-center z-50">
      <div className="relative max-w-screen-lg w-full h-full flex items-center justify-center">
        ...
        <button
          onClick={(e) => {
            e.stopPropagation(); // Prevents any further propagation of the event
            onClose();
          }}
        ...
        <img
          ...
          className="md:max-h-[60vh] max-h-[40vh] object-contain mx-auto rounded-lg shadow-lg"
        />
        ...
        <div className="absolute inset-0 flex items-center justify-between px-4">
          <button
            onClick={(e) => {
              e.stopPropagation(); // Prevents the click from closing the carousel
              handlePrev();
            }}
            className="text-gray-300 hover:text-white bg-black bg-opacity-50 p-2 rounded-full transition duration-300 hover:bg-opacity-75 shadow-lg flex justify-center items-center"
          >
