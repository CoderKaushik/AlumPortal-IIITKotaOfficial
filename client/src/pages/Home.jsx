...
const Home = () => {
  ...
  return (
    ...
    >
      ...
      {/* Director's message */}
      <div className="p-[10px] md:p-[2rem] md:m-12 w-full h-auto sm:h-[50rem] md:h-[30rem] flex flex-col md:flex-row">
        <div className="md:w-1/2 w-full h-auto flex flex-col justify-center items-center md:items-start px-4 space-y-4">
          <img
            src={iiitkotalogo}
        ...
        <div className="md:w-1/2 w-full h-full  flex  justify-center md:justify-start items-center p-3">
          <iframe
            className="w-full h-[20rem] md:w-[80%]  sm:w-[90%] sm:h-full   rounded-lg"
