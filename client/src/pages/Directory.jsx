...
const Directory = () => {
  ...
  return (
    <div className="flex flex-col w-screen h-screen">
      <Navbar />
      <div className="flex-grow bg-gray-100 mt-[8.5rem] max-w-980:mt-[90px] max-w-492:mt-[65px] md:px-4">
        <div className="w-full h-auto flex md:gap-4 mt-4">
          ...
          <div className="xl:w-[80%] w-full flex flex-col gap-4 h-auto">
